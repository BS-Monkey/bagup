      ...
      <HeroContainer id='portable-title'>
        <Wrapper>
          <AnchorContainer href={'#portable-title'}>
            ...
            <H2>{t("Your Web3 Username")}<Anchor /></H2>
          </AnchorContainer>
          {/* <P>{t("home.portableUsername.text")}</P> */}
          <P>{t("No more sandboxed usernames. Own your username, store an avatar and other profile data, and use it across services.")}</P>
          <Gap size={10} />
          <Avatar />
        </Wrapper>
      </HeroContainer>
